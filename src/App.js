...
const App = () => {
  ...
  return (
    <div>
      ...
      {weatherData && (
        <section className='border border-black w-full mt-4 flex justify-between'>
          <aside className=' w-[50%] mt-5 ml-5 space-y-3'>
            <div className='border border-white rounded-lg flex items-center justify-between'>
              <div className='ml-5 space-y-5 py-4'>
                <h1 >Name :<span className='ml-3'>{weatherData.location.name}</span></h1>
          ...
          <aside className='border border-white w-[45%] mt-5 mr-5 rounded-lg'>
            <h1 className='text-xl font-bold text-center my-2'>Here is the Complete Weather Conditions</h1>
